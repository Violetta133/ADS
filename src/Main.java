...
public class Main {
    public static void main(String[] args) {
        ...
        // 2
        int[] arr2 = {3, 2, 4, 1};
        System.out.println("Average: " + Average.calculateAverage(arr2));
        ...
        // 9
        System.out.println("C(2,1) = " + BinomialCoefficient.binomialCoefficient(2, 1));
        System.out.println("C(7,3) = " + BinomialCoefficient.binomialCoefficient(7, 3));
